...
export default function History() {
    const historyData = [
        { title: "Routine Checkup", doctor: "Dr. Sarah Johnson", date: "2024-02-10", status: "Completed", iconColor: "var(--pill-purple-text)", iconBg: "var(--pill-purple-bg)" },
        { title: "Fever", doctor: "Dr. Michael Chen", date: "2024-01-25", status: "Completed", iconColor: "var(--pill-purple-text)", iconBg: "var(--pill-purple-bg)" },
        { title: "Blood Pressure Check", doctor: "Dr. Emily Davis", date: "2023-12-10", status: "Completed", iconColor: "var(--pill-purple-text)", iconBg: "var(--pill-purple-bg)" },
        { title: "General Consultation", doctor: "Dr. Robert Wilson", date: "2023-11-15", status: "Completed", iconColor: "var(--pill-purple-text)", iconBg: "var(--pill-purple-bg)" }
    ];
